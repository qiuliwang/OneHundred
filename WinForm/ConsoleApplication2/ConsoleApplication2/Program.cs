...
namespace ConsoleApplication2
{
    class Program
    {
        ...
        static string getinput()
        {
            ...
            {
                System.Console.WriteLine("*** y(yes) 或者 n(no)");
                str = System.Console.ReadLine();
            }
            return str;
        }
        ...
        static void Main(string[] args)
        {
            ...
            else if (str == "y" || str == "yes")
            {
                ...
                Thread.Sleep(4000);
                System.Console.WriteLine("100天可以很短，因为从开始到现在，感觉好像只是做了一个长梦。");
                Thread.Sleep(5000);
                ...
                Thread.Sleep(4000);
                System.Console.WriteLine("*** 但是我知道他啊，不是他不想说，是他紧张了。"); ;
                Thread.Sleep(4000);
                System.Console.WriteLine("*** 他肯定是非常爱你的了。放心吧。"); ;
                Thread.Sleep(4000);
                System.Console.WriteLine("*** 他试了C#、Java，结果他发现，自己已经笨到连Java都不会了。"); ;
                Thread.Sleep(4000);
                System.Console.WriteLine("*** 他差点把键盘砸了。所以他只能用最简单的方式来构建我了。"); ;
                Thread.Sleep(4000);
                ...
                string temp;
                System.Console.WriteLine("*** 输入任何字符结束程序。");
